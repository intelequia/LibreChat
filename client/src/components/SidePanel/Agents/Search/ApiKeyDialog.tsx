...
export default function ApiKeyDialog({
  ...
  const rerankerOptions: DropdownOption[] = [
    ...
    {
      key: RerankerTypes.CUSTOMLOCAL,
      label: localize('com_ui_web_search_reranker_custom'),
      inputs: {
        customRerankerUrl: {
          placeholder: localize('com_ui_web_search_custom_reranker_url'),
          type: 'text' as const,
        },
      },
    },
    ...
    >
      <OGDialogTemplate
        ...
        selection={{
          ...
          selectClasses: 'bg-surface-submit hover:bg-surface-submit-hover text-text-on-status',
