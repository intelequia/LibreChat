...
export interface ToolResources {
  codeInterpreter?: CodeInterpreterResource;
...
export type TAssistantsMap = Record<AssistantsEndpoint, Record<string, AzureAgent>>;

export type AzureAgentCreateParams = {
  model: string;
  description?: string | null;
  file_ids?: string[];
  instructions?: string | null;
...
export type AzureAgentUpdateParams = {
  model?: string;
  description?: string | null;
  file_ids?: string[];
  instructions?: string | null;
...
export type AzureAgentListParams = {
  limit?: number;
  before?: string | null;
  after?: string | null;
  order?: 'asc' | 'desc';
...
export enum AzureAgentStreamEvents {
